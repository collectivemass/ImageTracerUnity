...
using ImageTracerUnity.Extensions;
using UnityEngine;

namespace ImageTracerUnity.Palettes
{
    ...
    internal class GaussianBlur
    {
            ...
            int endY)
        {
            ...
            Texture2D firstPass = new Texture2D(source.width, source.height);
            ...
            float[,] kernel)
        {
            ...
            int sourceBottom = sourceRectangle.yMax;
            int startX = sourceRectangle.x;
            int endX = sourceRectangle.xMax;
            ...
            for(var y = startY; y < endY; ++y)
                {
                    ...
                    for (int fy = 0; fy < kernelHeight; fy++)
                            ...
                            target.SetPixel(x, y, new Color32((byte)red, (byte)green, (byte)blue, (byte)alpha));
                        }
                    }
                }
        }
