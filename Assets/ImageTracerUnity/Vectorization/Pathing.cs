...
using DirectedEdgeList = System.Collections.Generic.List<ImageTracerUnity.Vectorization.DirectedEdge>;
using static ImageTracerUnity.Vectorization.EdgeNode;
using static ImageTracerUnity.Vectorization.WalkDirection;
